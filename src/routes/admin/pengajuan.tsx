...
export const Route = createFileRoute("/admin/pengajuan")({
  validateSearch: (search: Record<string, unknown>) => {
    return {
      ...
      noKtm:
        search.noKtm === "true" || search.noKtm === true ? "true" : undefined,
      noSkripsi:
        search.noSkripsi === "true" || search.noSkripsi === true
          ? "true"
          : undefined,
            ...
            {searchParams.tahun && searchParams.tahun !== "all" && (
              <Badge variant="secondary" className="gap-1 font-normal py-0.5 px-2 bg-muted/60">
                ...
                <X
                  ...
                  onClick={() =>
                    navigate({
                      search: { ...searchParams, tahun: undefined, page: 1 },
                    })
                  }
                />
              </Badge>
            ...
            {searchParams.noKtm === "true" && (
              <Badge variant="secondary" className="gap-1 font-normal py-0.5 px-2 bg-muted/60">
                ...
                <X
                  ...
                  onClick={() =>
                    navigate({
                      search: { ...searchParams, noKtm: undefined, page: 1 },
                    })
                  }
                />
              </Badge>
